...
const DICT = {
      ...
      items: [
        {
          ...
          link: 'https://weixin.qq.com/sph/A0BvA7VIIp', platform: 'weixin', poster: 'film-purax-1.jpg',
        },
        {
          no: 'FILM 02',
          tag: '手机 · 核心产业',
          ...
          link: 'https://weixin.qq.com/sph/AJ3EWxMLgz', platform: 'weixin', poster: 'film-purax-2.jpg',
        },
        {
          no: 'FILM 03',
          tag: '手机 · 核心产业',
          ...
          link: 'https://weixin.qq.com/sph/AERX1neTrJ', platform: 'weixin', poster: 'film-purax-3.jpg',
        },
        {
          no: 'FILM 04',
          tag: '运动健康',
          ...
          link: 'https://weixin.qq.com/sph/Ak1a2JvVfs', platform: 'weixin', poster: 'film- watch ultimate2.jpg',
        },
        {
          no: 'FILM 05',
          tag: '运动健康',
          ...
          link: 'https://weixin.qq.com/sph/AUtVlQGYqn', platform: 'weixin', poster: 'film- watch ultimate1.jpg',
        },
        {
          no: 'FILM 06',
          tag: '运动健康',
          ...
          v: 'watch-gt6', poster: 'film- watchgt6.jpg',
        },
        {
          no: 'FILM 07',
          tag: '运动健康',
          ...
          link: 'https://weixin.qq.com/sph/AuQvd1F1Qf', platform: 'weixin', poster: 'film- watchgt5.jpg',
        },
        {
          no: 'FILM 08',
          tag: '智慧办公',
          ...
          link: 'https://v.douyin.com/OcFh5CiTbTs/', platform: 'douyin', poster: 'film- matebook-1.jpg',
        },
        {
          no: 'FILM 09',
          tag: '智慧办公',
          ...
          link: 'https://v.douyin.com/ZDuRJ1FRo_c/', platform: 'douyin', poster: 'film- matebook-2.jpg',
        },
        {
          no: 'FILM 10',
          tag: '智慧办公',
          t: 'MatePad × 乌江画廊游学',
          d: '华为平板走进重庆乌江画廊：用科技赋能游学场景，记录师生用 MatePad 创作的在地文化之旅。',
          link: 'https://weixin.qq.com/sph/AJSeBeMR0p', platform: 'weixin', poster: 'film- matepad-1.jpg',
        },
        {
          no: 'FILM 11',
          tag: '智慧办公',
          ...
          link: 'https://weixin.qq.com/sph/Acis50asNQ', platform: 'weixin', poster: 'film- matepad-2.jpg',
        },
      ],
    },
    matrix: {
      ...
      accounts: [
        { name: '小雪哈基米', cat: '颜值向', catEn: 'LOOKS', link: 'https://v.douyin.com/OW1-lkBBQNU/', img: 'account-xiaoxue' },
        { name: '好运将0', cat: '颜值向', catEn: 'LOOKS', link: 'https://v.douyin.com/WqZpp37PtZ8/', img: 'account-haoyun' },
        { name: '年年有为的猪猪', cat: '颜值向', catEn: 'LOOKS', link: 'https://v.douyin.com/QEXgVYxNrZQ/', img: 'account-niannian' },
        { name: '涂涂不是大耳朵', cat: '数码向', catEn: 'TECH', link: 'https://v.douyin.com/QErQSN9YEqU/', img: 'account-tutu' },
        { name: '小张聊数码', cat: '数码向', catEn: 'TECH', link: 'https://v.douyin.com/ra10ZlzzGWY/', img: 'account-xiaozhang' },
        { name: 'CT爱数码', cat: '数码向', catEn: 'TECH', link: 'https://v.douyin.com/6LfUB_68Uuk/', img: 'account-ct' },
        { name: '祥佳音数码', cat: '抽象玩梗', catEn: 'MEME', link: 'https://v.douyin.com/qODUeBV5DDk/', img: 'account-xiangjiayin' },
        { name: '虾仁不眨眼', cat: '抽象玩梗', catEn: 'MEME', link: 'https://v.douyin.com/VhPl42v60Gs/', img: 'account-xiaren' },
        { name: '小闪电', cat: '抽象玩梗', catEn: 'MEME', link: 'https://v.douyin.com/0tsBXK2O7f8/', img: 'account-xiaoshandian' },
        { name: '可乐可乐不加奶', cat: '抽象玩梗', catEn: 'MEME', link: 'https://v.douyin.com/WgozB6wE-tE/', img: 'account-kele' },
      ],
    },
    explore: {
      part: 'PART  04',
  ...
  en: {
    ...
    marquee: {
      m1: '✦  The aim of marketing is to make selling superfluous  ✦  Regional Marketing Lead',
    ...
    films: {
      ...
      note: 'Click any card to open the video on its platform',
      ...
      items: [
        ...
        },
        {
          no: 'FILM 10',
          tag: 'Smart Office',
          t: 'MatePad × Wujiang Gallery Field Trip',
          d: 'Huawei tablet on a Wujiang Gallery field trip: empowering students & teachers with MatePad for local culture documentation & digital creation.',
          link: 'https://weixin.qq.com/sph/AJSeBeMR0p', platform: 'weixin', poster: 'film- matepad-1.jpg',
        },
        {
          no: 'FILM 11',
    ...
    matrix: {
      ...
      accounts: [
        { name: 'xiaoxuehajimi', cat: 'Beauty', catEn: 'LOOKS', link: 'https://v.douyin.com/OW1-lkBBQNU/', img: 'account-xiaoxue' },
        { name: 'haoyunjiang0', cat: 'Beauty', catEn: 'LOOKS', link: 'https://v.douyin.com/WqZpp37PtZ8/', img: 'account-haoyun' },
        { name: 'niannianyouwei', cat: 'Beauty', catEn: 'LOOKS', link: 'https://v.douyin.com/QEXgVYxNrZQ/', img: 'account-niannian' },
        { name: 'tutubushidaerduo', cat: 'Tech', catEn: 'TECH', link: 'https://v.douyin.com/QErQSN9YEqU/', img: 'account-tutu' },
        { name: 'xiaozhangliaoshuma', cat: 'Tech', catEn: 'TECH', link: 'https://v.douyin.com/ra10ZlzzGWY/', img: 'account-xiaozhang' },
        { name: 'CTaishuma', cat: 'Tech', catEn: 'TECH', link: 'https://v.douyin.com/6LfUB_68Uuk/', img: 'account-ct' },
        { name: 'xiangjiayinshuma', cat: 'Meme', catEn: 'MEME', link: 'https://v.douyin.com/qODUeBV5DDk/', img: 'account-xiangjiayin' },
        { name: 'xiarenbuzhayan', cat: 'Meme', catEn: 'MEME', link: 'https://v.douyin.com/VhPl42v60Gs/', img: 'account-xiaren' },
        { name: 'xiaoshandian', cat: 'Meme', catEn: 'MEME', link: 'https://v.douyin.com/0tsBXK2O7f8/', img: 'account-xiaoshandian' },
        { name: 'kelekelebujianai', cat: 'Meme', catEn: 'MEME', link: 'https://v.douyin.com/WgozB6wE-tE/', img: 'account-kele' },
      ],
    },
    explore: {
      part: 'PART  04',
